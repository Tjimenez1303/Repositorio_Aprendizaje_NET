using _1_Web_Aplication_PDF.Models;
...
namespace _1_Web_Aplication_PDF.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            // Configura la licencia QuestPDF
            ...
            var data =  Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    {
                        // Ruta de la imagen del Header
                        var rutaImagen = Path.Combine(_host.WebRootPath, "images/VisualStudio.png"); // Path.Combine -> Sirve para combinar dos rutas (ruta del hosting y ruta de la imagen en el proyecto)

                        // Convertimos la ruta de imagen en un array de de bytes
                        ...
                        // Fila 1 del header
                        row
                            .ConstantItem(150)  // Crear un item en que el tamaño sea proporcional en todos || ConstantItem() -> Fijar el ancho de esa columna
                            .Image(imageData);
            ...
            // Transformamos la variable data (que es un mapa de bits) a un Stream
            Stream stream = new MemoryStream(data);

            // Returnamos un archivo PDF
