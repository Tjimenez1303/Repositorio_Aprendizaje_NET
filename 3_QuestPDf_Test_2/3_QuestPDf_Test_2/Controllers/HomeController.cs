using _3_QuestPDf_Test_2.Models;
...
namespace _3_QuestPDf_Test_2.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            // Configuramos la liecencia de QuestPDF
            ...
            // Transformamos la variable data a un Stream
            Stream stream = new MemoryStream(data);

            // Returnamos un archivo PDF
            return File(stream, "application/pdf", "QuestPDF.pdf");
        }
    }
}